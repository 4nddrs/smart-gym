...
PORT: str = "8000"
RECOGNITION_API_KEY: str = "85c094c6-e31a-4c00-9573-67b4eed440d6"
...
image_path: str = "C:/Users/Andre/Downloads/w.jpg"
...
face: dict = next(
    item for item in face_collection.list().get("faces") if item["subject"] == "Andres"
)
